...
final readonly class McpClient {
	...
	public static function all( string $endpoint_url ): array {
		...
		return [
			new self(
				id: 'claude',
				name: __( 'Claude', 'agentgate-mcp-for-woocommerce' ),
				blurb: __( 'Web, mobile and the desktop app — one connection covers all three, and it shows up in Claude Code too.', 'agentgate-mcp-for-woocommerce' ),
				group: ClientGroup::Cloud,
				steps: [
					__( 'Open Claude, then go to Customize → Connectors and press the + button.', 'agentgate-mcp-for-woocommerce' ),
					__( 'Choose "Add custom connector", give it a name and paste the store URL.', 'agentgate-mcp-for-woocommerce' ),
					__( 'Press Add, then Connect — your browser opens this store\'s consent screen.', 'agentgate-mcp-for-woocommerce' ),
					__( 'Approve the scopes you want to grant. On Team and Enterprise plans an owner has to add the connector first.', 'agentgate-mcp-for-woocommerce' ),
				],
				snippet: $endpoint_url,
				snippet_label: __( 'Server URL', 'agentgate-mcp-for-woocommerce' ),
				open_url: 'https://claude.ai/customize/connectors',
				open_label: __( 'Copy URL & open Claude', 'agentgate-mcp-for-woocommerce' ),
			...
			new self(
				...
				blurb: __( 'Add the store as a custom connector. Needs a paid plan with developer mode switched on.', 'agentgate-mcp-for-woocommerce' ),
				group: ClientGroup::Cloud,
				steps: [
					__( 'In ChatGPT, open Settings → Apps & Connectors → Advanced and turn on Developer mode.', 'agentgate-mcp-for-woocommerce' ),
					__( 'Back in Connectors, choose "Add custom connector" and paste the store URL.', 'agentgate-mcp-for-woocommerce' ),
					__( 'Connect, then approve the scopes on this store\'s consent screen.', 'agentgate-mcp-for-woocommerce' ),
					__( 'Custom connectors are web only, and are not available on the free plan.', 'agentgate-mcp-for-woocommerce' ),
				],
				snippet: $endpoint_url,
				snippet_label: __( 'Server URL', 'agentgate-mcp-for-woocommerce' ),
				open_url: 'https://chatgpt.com/#settings/Connectors',
				open_label: __( 'Copy URL & open ChatGPT', 'agentgate-mcp-for-woocommerce' ),
			...
			new self(
				...
				steps: [
					__( 'Press the button below — Cursor opens and asks you to confirm the server.', 'agentgate-mcp-for-woocommerce' ),
					__( 'Confirm, then approve the scopes on this store\'s consent screen.', 'agentgate-mcp-for-woocommerce' ),
					__( 'If your browser blocks the link, paste the JSON below into your mcp.json instead.', 'agentgate-mcp-for-woocommerce' ),
				],
				...
				install_label: __( 'Add to Cursor', 'agentgate-mcp-for-woocommerce' ),
				docs_url: 'https://cursor.com/docs/context/mcp',
				match_hosts: [ 'cursor.com', 'cursor.sh' ],
			),
			new self(
				id: 'vscode',
				name: __( 'VS Code', 'agentgate-mcp-for-woocommerce' ),
				blurb: __( 'Use store tools from Copilot Chat in Visual Studio Code.', 'agentgate-mcp-for-woocommerce' ),
				group: ClientGroup::Local,
				steps: [
					__( 'Press the button below — VS Code opens and asks you to confirm the server.', 'agentgate-mcp-for-woocommerce' ),
					__( 'Confirm, then approve the scopes on this store\'s consent screen.', 'agentgate-mcp-for-woocommerce' ),
					__( 'Manage it later with "MCP: List Servers" from the Command Palette.', 'agentgate-mcp-for-woocommerce' ),
				],
				snippet: $endpoint_url,
				snippet_label: __( 'Server URL', 'agentgate-mcp-for-woocommerce' ),
				install_url: self::vscode_deeplink( $slug, $endpoint_url ),
				install_label: __( 'Add to VS Code', 'agentgate-mcp-for-woocommerce' ),
			...
			new self(
				...
				blurb: __( 'Manage the store from your terminal. Already covered if you connected Claude above.', 'agentgate-mcp-for-woocommerce' ),
				group: ClientGroup::Local,
				steps: [
					...
					__( 'Approve the scopes you want to grant.', 'agentgate-mcp-for-woocommerce' ),
				],
			...
			new self(
				...
				group: ClientGroup::Local,
				steps: [
					__( 'Add the store URL as a streamable HTTP MCP server.', 'agentgate-mcp-for-woocommerce' ),
					__( 'The client discovers authorization automatically (OAuth 2.1 with PKCE).', 'agentgate-mcp-for-woocommerce' ),
					__( 'Approve the scopes on this store\'s consent screen.', 'agentgate-mcp-for-woocommerce' ),
				],
				snippet: $endpoint_url,
				snippet_label: __( 'Server URL', 'agentgate-mcp-for-woocommerce' ),
