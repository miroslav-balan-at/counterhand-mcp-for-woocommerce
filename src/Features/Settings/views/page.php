...
$agmcp_tabs = [
	// Two separate systems: Chat runs a model here; Connect exposes the store
	// to outside AI apps over OAuth.
	'playground'  => __( 'Chat', 'agentgate-mcp-for-woocommerce' ),
	'connect'     => __( 'Connect apps', 'agentgate-mcp-for-woocommerce' ),
