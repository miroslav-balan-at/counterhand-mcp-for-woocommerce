 ...
 *
 * @var \Counterhand\Features\Tokens\Admin\ConnectionsListTable $list_table
 */
...
<p class="description">
	<?php esc_html_e( 'Each connection is an AI assistant that completed the browser consent flow. Revoking one immediately cuts off its access.', 'counterhand-mcp-for-woocommerce' ); ?>
</p>
